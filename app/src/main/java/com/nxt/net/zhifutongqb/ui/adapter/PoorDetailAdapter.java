...
public class PoorDetailAdapter extends RecyclerView.Adapter<PoorDetailAdapter.MyViewHolder>
{
	private static final String TAG = "PoorDetailAdapter";
	...
	public PoorDetailAdapter(Context context, List<GalleryModel> datas)
	{
	...
	public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
	{
		MyViewHolder holder = new MyViewHolder(mInflater.inflate(
				R.layout.item_of_poor, parent, false));
		return holder;
	}
