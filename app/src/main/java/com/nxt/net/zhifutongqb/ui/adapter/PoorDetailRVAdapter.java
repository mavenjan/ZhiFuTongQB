...
public class PoorDetailRVAdapter extends RecyclerView.Adapter<PoorDetailRVAdapter.MyViewHolder>
{
	...
	public PoorDetailRVAdapter(Context context, List<GalleryModel> datas)
	{
	...
	public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
	{
		MyViewHolder holder = new MyViewHolder(mInflater.inflate(
				R.layout.item_poor_detail_photo, parent, false));
		return holder;
	}
...
//		mDatas.add(position, "Insert One");
	...
	class MyViewHolder extends ViewHolder
	{
		...
		public MyViewHolder(View view)
		{
			...
			tvAddress = (TextView) view.findViewById(R.id.item_remark);
		}
	}
}